...
Добро пожаловать! Это дружелюбный погодный проект, который умеет получать данные от OpenWeatherMap и красиво показывать их в терминале и в Telegram. Бот получился умным, отзывчивым и очень удобным: быстрый отклик, наглядные прогнозы, геолокация, сравнение городов и полезные уведомления — всё в одном месте.
